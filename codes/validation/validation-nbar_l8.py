...
# output_dir = '/tower/git_hub/marujore/c-factor-article/validation/l8_nbar/'
...
output_dir = '/dados/Rennan/harmonization/validation/l8_nbar/'
bands = ['B2', 'B3', 'B4', 'B5', 'B6', 'B7']
...
for pair in pairs:
    ...
    for b in bands:
        ...
        raster1_path = navigate.path_to_l8nbarband(input_dir_l8, pair[0], b)
        raster2_path = navigate.path_to_l8nbarband(input_dir_l8, pair[1], b)
