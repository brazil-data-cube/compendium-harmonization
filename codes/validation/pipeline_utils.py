...
def validation_sr_s2_sen2cor(input_dir: str, cloud_dir: str, output_dir: str, pairs: Tuple[str,str], bands10m: List[str], bands20m: List[str]) -> None:
...
def validation_sr_s2_lasrc(input_dir: str, cloud_dir: str, output_dir: str, pairs: Tuple[str,str], bands: List[str]) -> None:
...
def validation_sr_l8_s2_sen2cor(input_dir_l8: str, cloud_dir_l8: str, input_dir_s2: str, cloud_dir_s2: str, output_dir: str, pairs: Tuple[str,str], bands_l8: List[str], bands_s2: List[str]) -> None:
    ...
    validation_funcs.write_dict(comparison_metrics, os.path.join(output_dir, 'comparison_metrics_sr_l8_s2_sen2cor.json'))
...
def validation_nbar_l8_s2_sen2cor(input_dir_l8: str, cloud_dir_l8: str, input_dir_s2: str, cloud_dir_s2: str, output_dir: str, pairs: Tuple[str,str], bands_l8: List[str], bands_s2: List[str]) -> None:
    ...
    validation_funcs.write_dict(comparison_metrics, os.path.join(output_dir, 'comparison_metrics_nbar_l8_s2_sen2cor.json'))
...
def validation_nbar_l8_s2_lasrc(input_dir_l8: str, cloud_dir_l8: str, input_dir_s2: str, cloud_dir_s2: str, output_dir: str, pairs: Tuple[str,str], bands_l8: List[str], bands_s2: List[str]):
    ...
    validation_funcs.write_dict(comparison_metrics, os.path.join(output_dir, 'comparison_metrics_nbar_l8_s2_lasrc.json'))
