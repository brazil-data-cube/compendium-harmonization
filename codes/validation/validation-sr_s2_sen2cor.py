...
# local
# input_dir = '/home/marujo/Downloads/validation/s2_sr_sen2cor'
# cloud_s2_dir = input_dir
# output_dir = '/tower/git_hub/marujore/c-factor-article/validation/s2_sr_sen2cor/'
...
cloud_s2_dir = input_dir
output_dir = '/dados/Rennan/harmonization/validation/s2_sr_sen2cor/'
...
for pair in pairs:
    ...
    for b in bands:
        ...
        raster1_path, res = navigate.path_to_s2srsen2cor_band(input_dir, pair[0], b)
        raster1_ds = rasterio.open(raster1_path)

        raster2_path, res = navigate.path_to_s2srsen2cor_band(input_dir, pair[1], b)
