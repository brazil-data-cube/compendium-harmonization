...
# input_dir_s2 = '/home/marujo/Downloads/validation/s2_sr_lasrc'
# cloud_s2_dir = '/home/marujo/Downloads/validation/s2_sr_sen2cor'
# output_dir = '/tower/git_hub/marujore/c-factor-article/validation/l8-s2-lasrc_sr/'
...
input_dir_s2 = '/dados/Rennan/harmonization/work/s2_sr_lasrc'
cloud_s2_dir = '/dados/Rennan/harmonization/work/s2_sr_sen2cor'
output_dir = '/dados/Rennan/harmonization/validation/l8-s2-lasrc_sr/'
...
for pair in pairs:
    ...
    for b in range(len(l8bands)):
        ...
        raster1_path = navigate.path_to_l8srband(input_dir_l8, pair[0], l8bands[b])
        raster2_path = navigate.path_to_s2srlasrc_band(input_dir_s2, pair[1], s2bands[b])
