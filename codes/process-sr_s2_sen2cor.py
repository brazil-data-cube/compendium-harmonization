...
output_dir = '/dados/Rennan/harmonization/work/s2_sr_sen2cor'

for sceneid in sceneids:
    print(f'docker run --rm -v {input_dir}:/mnt/input-dir:rw -v {output_dir} sen2cor-2.9.0_fmask-4.3 {sceneid}')
