...
!!! tip "Image name"
    ...
    On the following commands, a `sensor-harm` Docker Image is identified as `marujore/nbar:latest`, stored in the profile [marujore](https://hub.docker.com/u/marujore) on DockerHub.
